...
#' @keywords external
#' @export
my_plot<-function(x,y,sd = NULL, overlay = NULL,ylab = NULL,xlab = NULL, ylim = NULL,xlim = NULL,pch = NULL,bg = NULL, type = NULL, xaxt = NULL, yaxt = NULL){
...
if (is.null(overlay)==TRUE){
      plot(x,y,ylab=ylab,xlab=xlab,las=1,ylim = ylim, xlim = xlim, 
           pch = pch, bg = bg,type = type, col = bg,
           xaxt = xaxt, yaxt = yaxt)  
